...
from models.tools.interfaces import conv2d_args_preprocessor, generate_legacy_interface
...
class DepthwiseConv2D1(Conv2D):
    ...
    def __init__(self, filters,
                 ...
                 **kwargs):
        super(DepthwiseConv2D1, self).__init__(
            filters=filters,
...
# rate=self.dilation_rate
    ...
    def get_config(self):
        config = super(DepthwiseConv2D1, self).get_config()
...
DepthwiseConvolution2D = DepthwiseConv2D1
